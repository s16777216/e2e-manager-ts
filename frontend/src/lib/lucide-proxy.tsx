...
export { FoldersIcon as Folders, FoldersIcon as FolderOpen } from "../components/icon/folders";
export { FolderPlusIcon as FolderPlus } from "../components/icon/folder-plus";
export { HistoryIcon as History, HistoryIcon as Clock } from "../components/icon/history";
